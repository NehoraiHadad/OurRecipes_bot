...
class DynamoDBHandler:
    ...
    def update_item(self, key: Dict[str, Any], update_expression: str, expression_attribute_values: Dict[str, Any]) -> Dict[str, Any]:
...
class UserHandler(DynamoDBHandler):
    def register_user(
        ...
        if existing_user:
            ...
            return self.put_item(existing_user)
        else:
    ...
    def remove_accessed_recipe(self, user_id: str, recipe_id: str):
        ...
        if user:
            ...
            if recipe_id in accessible_recipes:
                ...
                expression_attribute_values = {":accessible_recipes": accessible_recipes}
